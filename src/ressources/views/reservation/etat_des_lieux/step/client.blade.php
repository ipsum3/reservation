                                                ...
                                                <table class="table table-hover table-striped"  style="min-width: 1000px">
                                                    ...
                                                    @foreach($reservation->conducteurs as $conducteur)
                                                        <tr>
                                                            ...
                                                            <td><input class="form-control" type="date" disabled name="conducteurs[{{ $i }}][naissance_at]" value="{{ old('naissance_at', $conducteur->naissance_at) }}" /></td>
                                                            ...
                                                            <td><input class="form-control" type="date" disabled name="conducteurs[{{ $i }}][permis_at]" value="{{ old('permis_at', $conducteur->permis_at) }}" /></td>
