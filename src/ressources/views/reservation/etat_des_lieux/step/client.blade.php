        ...
        <div class="col-md-12">
            ...
            <div class="box">
                    ...
                    <div class="form-row">
                        <div class="col-md-12">
                            ...
                            <div class="mb-6">
                                ...
                                <h3 class="mt-4">Informations réservation</h3>
                                <div class="form-row">
                ...
                <div class="box-footer">
                    <div><a href="{{ route('admin.inspection.vehicule', [$reservation, $type]) }}" id="prevBtn" class="btn btn-outline-secondary">Retour</a></div>
                    <div><a href="{{ route('admin.inspection.checklist', [$reservation, $type]) }}" id="nextBtn" class="btn btn-primary">Suivant</a></div>
                </div>
            </div>
