...
@section('content')
    ...
    {{ Aire::open()->route($categorie->exists ? 'admin.categorie.update' : 'admin.categorie.store', $categorie->exists ? [$categorie] : '')->bind($categorie)->formRequest(\Ipsum\Reservation\app\Http\Requests\StoreCategorie::class) }}
    <div class="box">
