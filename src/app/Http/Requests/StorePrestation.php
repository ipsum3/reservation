...
class StorePrestation extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            "age_min" => "nullable|numeric|min:16|max:120",
            "jour_depart" => ["nullable", Rule::in(array_keys(\Ipsum\Reservation\app\Models\Lieu\Horaire::JOURS))],
            "jour_retour" => ["nullable", Rule::in(array_keys(\Ipsum\Reservation\app\Models\Lieu\Horaire::JOURS))],
            "condition" => ["nullable", Rule::in(array_keys(Prestation::$LISTE_CONDITION))],
            "categorie_type_id" => ["nullable", Rule::exists(Type::class, 'id')],
            "heure_max_depart" => ["nullable"],
            "heure_max_retour" => ["nullable"],
            "heure_min_depart" => ["nullable"],
            "heure_min_retour" => ["nullable"],
            "is_cumulable" => ["nullable", "boolean"],
